...
const IndexPage = () => (
  <Layout>
    ...
    <Section style={{ padding: "3rem 0rem 1rem 0rem" }}>
      ...
      <p style={{ marginBottom: "1rem" }}>
        Our secret is simple: we use only the freshest ingredients and honor the
        culinary lessons that have been passed from generation to generation in
        our family. Haili’s Hawaiian Foods is the place to call, whether you’re
        looking for a great place to dine-in or you want delicious food
    ...
    <Section style={{ padding: " 1rem 0rem 3rem 0rem" }}>
      ...
      <p style={{ marginBottom: "1rem" }}>
        ...
        customers enjoy the most. From delicious poi and poke to Lomi salmon and
        sushi, we make it our mission to win our guests over as regulars with
        each mouth-watering bite.
      </p>
      <p style={{ marginBottom: "1rem" }}>
        If you enjoy our classic cuisine, consider hiring us for your event. We
        provide comprehensive catering services, including buffet service,
      ...
      <p style={{ marginBottom: "1rem" }}>
        ...
        remember Haili’s Hawaiian Foods. For decades, our customers have chosen
        us as their favorite Hawaiian restaurant in Honolulu, HI, because:
      </p>
      <ul style={{ marginLeft: "2rem", color: "var(--darkGray)" }}>
        ...
        <li style={{ fontSize: "0.8rem", marginBottom: "0.5rem" }}>
          We have been written up extensively for our excellent Hawaiian dishes.
        </li>
        <li style={{ fontSize: "0.8rem", marginBottom: "0.5rem" }}>
